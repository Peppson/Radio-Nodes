...
constexpr static uint32_t WATER_SENSOR_MIN_VALUE = 62UL;             // Calibrated value with EMPTY tank
constexpr static uint32_t WATER_SENSOR_MAX_VALUE = 260UL;            // Calibrated value with FULL tank
